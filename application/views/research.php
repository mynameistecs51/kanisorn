															...
															<div class="modal-content">
																...
																<div class="modal-body row">
																	<div class="text-center">
																		<object  width="500" height="500" data='<?php echo base_url();?>files_upload/file_research/<?php echo $research->res_file;?>' />
																		</object>
																	</div>
																</div>
															</div><!-- end modal -->
											...
											<tbody>
												...
												<?php foreach ($this->db->where('res_type','international')->order_by('res_id','ASC')->get('research')->result() as $research): ?>
													...
													<tr>
														<td><?php echo $no++;?></td>
														<td>
															<?php echo anchor('#/'.$research->res_id, "<b>".$research->res_name."</b><br/>". substr($research->res_detail,0,100));?>
														</td>
													</tr>
												<?php endforeach ?>
